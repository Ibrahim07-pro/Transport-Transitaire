...
export default function MesExpeditionsPage({ token }) {
  ...
  const getReadableStatus = (statut) => {
    switch (statut) {
      ...
      case "EN_ATTENTE_PAIEMENT_SOLDE": return { label: "Paiement du solde en attente", color: "warning" };
      case "SOLDE_PAYE": return { label: "Solde payé", color: "info" };
      ...
      default: return { label: "En attente de validation", color: "default" };
    }
  };
  ...
  const getProgressStep = (statut) => {
    switch (statut) {
      ...
      case "CHARGEMENT_EFFECTUE": return 2;
      case "SOLDE_PAYE": return 3;
  ...
  return (
    <Box sx={{ p: 3, minHeight: "100vh", backgroundColor: "#fafafa" }}>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", mb: 4 }}>
        ...
        {/* Lignes rejoignant le titre */}
        <Box sx={{ display: "flex", alignItems: "center", width: "100%", justifyContent: "center", gap: 3, mb: 2 }}>
              ...
              <Box key={mission.missionId}>
                ...
                >
                  ...
                  >
                    ...
                    {/* Barre de progression et bouton - Toujours en bas */}
                    <Box mt={2}>
                      <Stepper
                      ...
                      >
                        {["Acceptée", "Chauffeur", "Chargement", "Solde", "Livrée"].map((label) => (
                          <Step key={label}>
      ...
      <Dialog open={Boolean(selectedMission)} onClose={() => setSelectedMission(null)}>
        ...
        <DialogActions sx={{ p: 2 }}>
          ...
          <Button
            ...
            disabled={submitting}
            variant="contained"
            sx={{ backgroundColor: primaryColor, textTransform: "none", "&:hover": { backgroundColor: "#e65c00" } }}
          >
